...
const BUILT_IN_SHELL_BOOT_THEME_MAP: Record<string, Partial<ShellBootTheme>> = {
  ...
  'aurora-mist': {
    screenBg: '#341d28',
    cardBg: 'rgba(48, 25, 36, 0.78)',
    cardBorder: 'rgba(243, 173, 196, 0.26)',
    accent: '#f3adc4',
    buttonBg: '#f6b8cd',
    ...
    navBarBg: 'rgba(34, 17, 25, 0.88)',
    navButtonBg: 'rgba(243, 173, 196, 0.12)',
    navButtonActiveBg: 'rgba(170, 95, 123, 0.88)',
    navButtonActiveText: '#fff4f8',
    indicatorBg: 'rgba(243, 173, 196, 0.14)',
    transitionOverlay: 'rgba(24, 12, 18, 0.24)',
  },
  'amethyst-haze': {
    screenBg: '#24192f',
    cardBg: 'rgba(35, 25, 49, 0.8)',
    cardBorder: 'rgba(190, 155, 255, 0.26)',
    accent: '#be9bff',
    buttonBg: '#c5a8ff',
    ...
    navBarBg: 'rgba(23, 16, 32, 0.88)',
    navButtonBg: 'rgba(190, 155, 255, 0.12)',
    navButtonActiveBg: 'rgba(115, 83, 173, 0.88)',
    navButtonActiveText: '#f7f2ff',
    indicatorBg: 'rgba(190, 155, 255, 0.14)',
  ...
  'midnight-indigo': {
    screenBg: '#352211',
    cardBg: 'rgba(52, 33, 17, 0.8)',
    cardBorder: 'rgba(255, 196, 104, 0.28)',
    accent: '#ffc468',
    buttonBg: '#ffc970',
    ...
    navBarBg: 'rgba(34, 22, 11, 0.88)',
    navButtonBg: 'rgba(255, 196, 104, 0.12)',
    navButtonActiveBg: 'rgba(182, 128, 57, 0.9)',
    navButtonActiveText: '#4b2d11',
    indicatorBg: 'rgba(255, 196, 104, 0.14)',
    transitionOverlay: 'rgba(24, 16, 10, 0.26)',
  },
};
...
> = {
  ...
  'aurora-mist': {
    primary: '#341d28',
    secondary: 'rgba(89, 44, 63, 0.46)',
    tertiary: 'rgba(132, 76, 97, 0.52)',
    quaternary: 'rgba(243, 173, 196, 0.2)',
    accent: '#f3adc4',
    text: '#fff4f8',
    mutedText: 'rgba(255, 244, 248, 0.74)',
    border: '#c492a7',
    ...
    projectLevel2: '#c67d99',
    projectLevel3: '#8e4d67',
    panel: 'rgba(42, 23, 33, 0.66)',
    panelStrong: 'rgba(48, 25, 36, 0.78)',
    panelBorder: 'rgba(243, 173, 196, 0.26)',
    buttonBg: '#f6b8cd',
    buttonBgHover: '#fac8d9',
    buttonText: '#4a2433',
  ...
  'amethyst-haze': {
    primary: '#24192f',
    secondary: 'rgba(58, 41, 77, 0.46)',
    tertiary: 'rgba(95, 69, 126, 0.52)',
    quaternary: 'rgba(190, 155, 255, 0.2)',
    accent: '#be9bff',
    text: '#f7f2ff',
    mutedText: 'rgba(247, 242, 255, 0.74)',
    border: '#a78ccc',
    ...
    projectLevel2: '#9672d6',
    projectLevel3: '#63459b',
    panel: 'rgba(32, 23, 44, 0.66)',
    panelStrong: 'rgba(35, 25, 49, 0.78)',
    panelBorder: 'rgba(190, 155, 255, 0.26)',
    buttonBg: '#c5a8ff',
    buttonBgHover: '#d3bcff',
    buttonText: '#312048',
  ...
  'midnight-indigo': {
    primary: '#352211',
    secondary: 'rgba(92, 58, 27, 0.48)',
    tertiary: 'rgba(145, 95, 43, 0.54)',
    quaternary: 'rgba(255, 196, 104, 0.18)',
    accent: '#ffc468',
    text: '#fff7ea',
    mutedText: 'rgba(255, 247, 234, 0.74)',
    border: '#c29a63',
    ...
    projectLevel2: '#bc8b3e',
    projectLevel3: '#7e5924',
    panel: 'rgba(46, 29, 15, 0.68)',
    panelStrong: 'rgba(52, 33, 17, 0.8)',
    panelBorder: 'rgba(255, 196, 104, 0.28)',
    buttonBg: '#ffc970',
    buttonBgHover: '#ffd58f',
    buttonText: '#4b2d11',
